...
// }
void CANMotorMessage::addMessage(int des, uint8_t prevPos, uint8_t interaction, uint8_t color1, uint8_t color2) {
  uint8_t msg[4] = {prevPos, interaction, color1, color2};
  memcpy(this->msg.buf + des * 4, msg, 4);
}
